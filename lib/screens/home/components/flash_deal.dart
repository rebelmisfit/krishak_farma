...
class _FlashDealState extends State<FlashDeal> {
  @override
  Widget build(BuildContext context) {
    var Fruits = ['Apple', 'Banana', 'Grapes', 'Guava', 'Mango'];
              ...
              return ListTile(
                leading: CircleAvatar(
                  backgroundImage: AssetImage(
                    'assets/images/' + Fruits[index] + '_Small.png',
                  ),
                ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                "Deal Date : " +
                                    DateFormat('dd-MM-yyyy KK:mm:ss a').format(
                                        snapshot.data?.docs[index]['Deal_Date']
                                            .toDate()),
                                style: TextStyle(
                                    color: Colors.white, fontSize: 20),
                              ),
                        ...
                        trailing: IconBtnWithCounter(
                            ...
                            press: () {
                              Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ExtendedSearch()));
                            }),
                        leading: IconBtnWithCounter(
                            svgSrc: "assets/icons/User.svg", press: () {}),
